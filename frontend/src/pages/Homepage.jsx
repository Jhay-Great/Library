    ...
    <main className='w-full h-screen bg-transparent flex flex-col relative text-white'>
      <span 
        ...
        <section className='flex-auto flex flex-col justify-center items-center gap-10 px-2 '>
            ...
            <p className='font-poetsen text-xl text-center mt-10 uppercase'>Explore <Link className='font-extrabold text-[#fb0] hover:text-[#C8A219]' to='/collections'>Collections</Link></p>
        </section>
    </main>
  )
}
